...
using YawlUrl.Infrastructure.AspNetCore.Authorization;
using YawlUrl.Infrastructure.AspNetCore.Exceptions;
using YawlUrl.Infrastructure.AspNetCore.Models;
using YawlUrl.Infrastructure.AspNetCore.Models.AccountViewModels;
...
namespace YawlUrl.Web.Api.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public async Task<IActionResult> Register([FromBody] RegisterViewModel model)
        {
            ...
            return ResultAt(new { result = true, message = "The user created successfully!" }, StatusCodes.Status201Created);
        }
    }
}